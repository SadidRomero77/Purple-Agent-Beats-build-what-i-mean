"""Tests for the v3 Grid model."""
import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "src"))

from purple_v3.grid import Grid, GridConfig, Block
...
def test_unique_colors():
    g = Grid.from_str("Red,0,50,0;Blue,100,50,0;Red,200,50,0")
    colors = g.unique_colors()
    assert colors == {"Red", "Blue"}


def test_most_common_color():
    g = Grid.from_str("Red,0,50,0;Red,100,50,0;Blue,200,50,0")
    assert g.most_common_color() == "Red"
